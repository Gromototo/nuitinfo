...
// Supposons que vous avez une image d'herbe dans le même répertoire que votre script
const grassImagePath = 'https://upload.wikimedia.org/wikipedia/commons/7/77/Pixel_art_grass_image.png';

// Obtenez le corps du document
const body = document.body;

// Appliquez la nouvelle image en arrière-plan
body.style.backgroundImage = `url(${grassImagePath})`;
body.style.backgroundSize = 'cover';  // Ajustez la taille de l'image en fonction de vos besoins
  ...
  const STEP = 5
  const COLOR = {
    BACKGROUND: '#66CC66',        // Vert clair
    PACMAN: '#FFD700',            // Or
    POWER: '#FF9900',             // Orange
    MAP: '#000000',               // Noir
    FOOD: '#FFFFFF',              // Blanc
    CHERRY: '#CC0000',            // Rouge
    CHERRY_BRANCH: '#996633',     // Brun
    EYE: '#FFFFFF',               // Blanc
    GHOST_WEAK: '#000000',        // Gris
    GHOST: ['#FF6666', '#FFD700', '#996633', '#FF9900', '#FF66FF', '#00CC66']  // Rouge, Or, Brun, Orange, Rose, Vert foncé
  ...
  function drawElement(ele, obj) {
    ...
    switch (ele) {
      ...
      case ELEMENT.FOOD:
        ctx.fillStyle = COLOR.FOOD
        // Dessiner l'icône Font Awesome
        ctx.textBaseline = 'middle';
        ctx.textAlign = 'center';
         ctx.font = "25px FontAwesome";
         ctx.fillText("\uf787",x + SIZE.BLOCK / 2, y + SIZE.BLOCK / 2);
        break
